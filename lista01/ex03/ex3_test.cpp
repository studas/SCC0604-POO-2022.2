...
{
    int grau_maximo = 5;
    Polinomio poli_grau_5(grau_maximo);
    Termo novo_termo = Termo(1, 4);
    poli_grau_5.Add(Termo(2, 5));
    poli_grau_5.Add(Termo(0, 13));
    poli_grau_5.Add(novo_termo);

    poli_grau_5.Mostra();

    std::cout << "f(5) = " << poli_grau_5 << " = " << poli_grau_5.Calcula(5) << std::endl;
}
